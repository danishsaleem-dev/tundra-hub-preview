...
export default async function NewAthletePage() {
  ...
  // POST /api/athletes (create) is ADMIN-only.
  const body =
    user?.role === "ADMIN" ? (
      <AthleteCreateClient />
    ) : (
  ...
  return (
    <AppShell
      title={`New ${ENTITY_LABELS.athlete.singular}`}
      role={role}
